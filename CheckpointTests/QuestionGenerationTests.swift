...
final class QuestionGenerationTests: XCTestCase {
    ...
    func testStorePassesGoalContextAndDifficultyToQuestionEngine() async throws {
        ...
        XCTAssertTrue(sourcePrompt.contains("Difficulty guidance: Connect multiple reasoning steps or resolve interacting constraints."))
    ...
    func testBackendRequestEncodesGoalContextCompetenciesAndDifficulty() throws {
        ...
        XCTAssertEqual(payload["difficultyGuidance"] as? String, "Interpret evidence or a representation to distinguish plausible conclusions; scenario details must affect the answer.")
        ...
        XCTAssertTrue(sourcePrompt.contains("Difficulty guidance: Interpret evidence or a representation to distinguish plausible conclusions; scenario details must affect the answer."))

...
from complete_question_solution import COMPLETE_SOLUTION_SYSTEM_PROMPT, SOURCE_SOLUTION_SYSTEM_PROMPT
...
class CompleteQuestionVerificationTests(unittest.TestCase):
    ...
    def test_generation_selects_complete_contract_and_current_stamp_in_three_calls(self):
        ...
        self.assertEqual(accepted[0]["verificationPolicyRevision"], 6)
        self.assertEqual(client.solution_calls[0]["system"][0]["text"], SOURCE_SOLUTION_SYSTEM_PROMPT)

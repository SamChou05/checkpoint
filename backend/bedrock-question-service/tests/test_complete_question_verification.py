...
from complete_question_solution import COMPLETE_SOLUTION_SYSTEM_PROMPT, SUBJECT_REFERENCE_SYSTEM_PROMPT
...
class CompleteQuestionVerificationTests(unittest.TestCase):
    ...
    def test_generation_selects_complete_contract_and_current_stamp_in_three_calls(self):
        ...
        self.assertEqual(client.solution_calls[0]["system"][0]["text"], SUBJECT_REFERENCE_SYSTEM_PROMPT)

#!/usr/bin/env python3
"""Fresh source-policy qualification across both deployed authors; max 24 calls."""
import argparse
import hashlib
import json
import os
...
FIXTURE = SERVICE / 'evals/fixtures/source_policy_fresh.json'
...
def main():
    ...
    plan = {'cases': cases, 'authors': MODELS, 'settings': settings, 'maximum_calls': 24,

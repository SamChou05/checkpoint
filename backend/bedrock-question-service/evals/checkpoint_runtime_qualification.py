...
from complete_question_solution import COMPLETE_SOLUTION_SYSTEM_PROMPT, DISPLAYED_SOLUTION_SYSTEM_PROMPT, SOURCE_SOLUTION_SYSTEM_PROMPT, SUBJECT_REFERENCE_SYSTEM_PROMPT  # noqa: E402
...
def _role(request):
    ...
    if system in ([{"text": COMPLETE_SOLUTION_SYSTEM_PROMPT}], [{"text": DISPLAYED_SOLUTION_SYSTEM_PROMPT}], [{"text": SOURCE_SOLUTION_SYSTEM_PROMPT}], [{"text": SUBJECT_REFERENCE_SYSTEM_PROMPT}]):
        return "solver"

...
| July 11, 2026 | Physical build 4 launch | Physical test iPhone (identifier recorded locally) | Partial | Automated launch was denied because the phone was locked. Unlock and launch once, then visually confirm the migrated goal, progress, protection selection, and Free entitlement before any reset. |

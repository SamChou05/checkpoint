...
The subsequent [four-call author-schema comparison](QUESTION_AUTHOR_SCHEMA_EXPERIMENT.md) completed with schema-compliant responses in both arms under the runtime parser. It did not establish a correctness improvement: five authored code definitions were invalid as displayed. It also exposed a separate false rejection of legitimate method-call parentheses. No production schema or model setting was promoted.

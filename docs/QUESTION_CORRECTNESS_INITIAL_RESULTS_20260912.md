> Historical 102-call milestone. For the finished implementation and corrected conclusions, read [the final report](QUESTION_CORRECTNESS_ROOT_CAUSE_RESULTS_20260912.md). Statements about opt-in transport and intermediate context policies below describe that milestone, not current defaults.

...
def main():
    ...
    structure = {"planned_calls": 2, "attempted_calls": len(capture["calls"]), "valid_calls": len(valid),
                 ...
                 "all_exact_bindings_and_decoded_content": all(value["exact_bindings_and_decoded_content"] for value in assessments),
    ...
    result = {"plan_sha256": capture["plan_sha256"], "capture_sha256": probe.sha(probe.CAPTURE),
              "provider_calls_in_replay": 0, "checks": checks, "structurally_qualified_on_two_batches": structural_pass,

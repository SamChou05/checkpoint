...
SPEC = importlib.util.spec_from_file_location("constructed_worker_probe_tested", HERE / "mixed_probe.py")
...
class MixedProbeTests(unittest.TestCase):
    ...
    def test_three_real_mixed_jobs_use_eight_calls_and_preserve_compiler_fields(self):
        ...
        for call in network.calls:
            author = call["outputConfig"]["textFormat"]["structure"]["jsonSchema"]["name"] == probe.CONSTRUCTED_AUTHOR_CONTRACT

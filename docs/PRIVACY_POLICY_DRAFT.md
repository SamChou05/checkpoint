...
- For automatic Skill Map progression, the current and recent archived skill names plus bounded recent attempt outcomes, skill/objective identifiers, difficulty, and timestamps used to verify mastery.
